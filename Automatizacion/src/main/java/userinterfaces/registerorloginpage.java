...
public class registerorloginpage {
    ...
    public static final Target Btn_confir = Target.the("manterner precionado el boton").locatedBy("/html/body/div[1]/div/div/div/div[2]/div[1]/div/div/div/div/div/div/form/div[2]/div[2]");
