...
public class flightpage {
    ...
    public static final Target Btn_pasajeros = Target.the("se seleciona pasajeros").located(By.cssSelector("#basiclayout > div > div > div.css-1niqckn > div > div > div > div > div.css-7wh13m > div:nth-child(1) > div > button"));
    public static final Target Btn_pasajeros_ninos = Target.the("se seleciona la cantidad de pasajeros niños ").located(By.cssSelector("#\\:Rjd3b9\\: > div > div > div > div > div > div.css-6yc6o0 > div > div:nth-child(2) > div > div.InputStepper-module__wrapper___ITjSz > button.Actionable-module__root___o3y3\\+.Button-module__root___2Z2KR.Button-module__root--variant-tertiary___cjBJU.Button-module__root--icon-only___GOysd.Button-module__root--size-medium___\\+UaTJ.Button-module__root--wide-false___V33Sh.Button-module__root--variant-tertiary-action___JVws6.InputStepper-module__add___XhOwU"));
