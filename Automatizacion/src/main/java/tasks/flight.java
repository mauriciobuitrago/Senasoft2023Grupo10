...
public class flight implements Task {
    ...
    public flight(String lugar_salidad, String lugar_llegada) {
    ...
    public static flight flig(String lugar_salidad, String lugar_llegada){
        return Tasks.instrumented(flight.class, lugar_salidad, lugar_llegada);
